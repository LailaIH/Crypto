...
<body>
                        ...
                        <div class="owl-carousel testimonial-carousel py-5">
                            ...
                            <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="img-fluid flex-shrink-0 rounded" src="{{ isset($new->img)? asset('newsImages/'.$new->img) : \assets\img\home_6.jpg  }}" style="width: 45px; height: 45px;">
                                        <div class="ps-3">
       ...
       @endif    
            ...
            @if(auth()->user() && auth()->user()->is_registered)
                            ...
                            <div class="container">
                                ...
                                <div class="owl-carousel testimonial-carousel py-5">
                                    ...
                                    <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                                            ...
                                            <p>{{$recommendation->targets}}</p>
                                            <div class="d-flex align-items-center">
                                                <div class="ps-3">
                                                    <h6 class="fw-bold mb-1">{{$recommendation->entry}}</h6>
                ...
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4">Keep Up  <span class="text-primary text-uppercase">With Our Updates</span></h4>
        ...
        <div class="container newsletter mt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="row justify-content-center">
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4">Subscribe  <span class="text-primary text-uppercase">Now</span></h4>
                            <div class="position-relative mx-auto" style="max-width: 400px;">
                               
                            
                        
                                <form method="get" action="{{route('subscribe',auth()->user()->uuid)}}">
                                @csrf 
                                   <button type="submit" class="btn btn-primary px-3 position-absolute" style="margin-left:-3.5rem;">Subscribe</button>
                                </form>
                                </div>
                        </div>
                    </div>
